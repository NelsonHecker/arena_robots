"""Stage M acceptance tests for rbvogui's sensor migration (.claude/parametrized-robots.md
...
GOLDEN = Path(__file__).parent / "golden" / "rbvogui_premigration.urdf"
...
class TestEffectiveSensorsParity:
    ...
    def test_effective_sensors_matches_model_params(self) -> None:
        ...
        assert view.assembly is not None, "rbvogui must have migrated (assembly.yaml present)"
...
class TestUrdfStructuralParity:
    ...
    def test_wrapper_render_matches_golden(self, tmp_path: Path) -> None:
        ...
        wrapper_path = tmp_path / "rbvogui_wrapper.urdf.xacro"
        ...
        rendered_path = tmp_path / "rbvogui_wrapper.urdf"
