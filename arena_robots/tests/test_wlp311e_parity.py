"""Stage M acceptance tests for WLP311E's sensor migration
...
GOLDEN = Path(__file__).parent / "golden" / "WLP311E_premigration.urdf"
...
class TestEffectiveSensorsParity:
    ...
    def test_effective_sensors_matches_model_params(self) -> None:
        view = RobotIdentifier("WLP311E").resolve_sync()
        assert view.assembly is not None, "WLP311E must have migrated (assembly.yaml present)"
...
class TestUrdfStructuralParity:
    ...
    def test_wrapper_render_matches_golden(self, tmp_path: Path) -> None:
        ...
        wrapper_path = tmp_path / "WLP311E_wrapper.urdf.xacro"
        ...
        rendered_path = tmp_path / "WLP311E_wrapper.urdf"
