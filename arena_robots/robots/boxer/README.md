...
| `BOXER_PC_XYZ`       | `0 0 0`       | Customize the position of backpack PC.  Requires `BOXER_PC` to be `1`    |
| `BOXER_PC_RPY`       | `0 0 0`       | Customize the orientation of backpack PC.  Requires `BOXER_PC` to be `1` |

Supported `BOXER_PC_MODEL` values:
- `evs-2000` -- the Vecow EVS-2000 series industrial PC with GPU
- `ecx-2000` -- the Vecow ECX-2000 series industrial PC
